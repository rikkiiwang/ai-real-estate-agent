...
- **Rails** tests (191) cover the domain models and the full consumer marketplace, including the **Ask Atlas chatbot** omnichannel (channel switch + voice input) and profile-based intent triaging
