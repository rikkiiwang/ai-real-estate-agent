...
- **Rails** tests (201) cover the domain models and the full consumer marketplace, including the **Concierge** omnichannel thread + intent triaging (with the embedded glass-box agent replying in-thread)
